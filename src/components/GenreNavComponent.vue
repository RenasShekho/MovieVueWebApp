  ...
  <header>
    <div class="GenreNav">
      <nav>
        ...
        <RouterLink to="/ActionCom">Drama</RouterLink>
        <RouterLink to="/ActionCom">Crime</RouterLink>
        <RouterLink to="/ActionCom">Documentary</RouterLink>
        <RouterLink to="/ActionCom">Horror</RouterLink>
      </nav>
    </div>
  </header>
</template>
